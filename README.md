...
* **🛡️ Bulletproof Text Processing:** Includes a robust regex cleaning pipeline, a strict 10,000-word vocabulary cap, and safe `<UNK>` token handling to prevent Out-Of-Bounds indexing errors in production.
